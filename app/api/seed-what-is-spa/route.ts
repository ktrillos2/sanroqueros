...
export async function GET(req: NextRequest) {
  ...
  const data = {
    ...
    paragraphs: [
      {
        text:
          'Un spa para mascotas es mucho más que un simple baño. Es una experiencia integral de bienestar que combina técnicas profesionales de grooming con tratamientos relajantes y terapéuticos, diseñados para el cuidado y la salud de perros y gatos.',
      },
      {
        text:
