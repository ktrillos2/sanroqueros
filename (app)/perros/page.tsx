        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="space-y-6 animate-fade-in">
              <Badge className="bg-[#FFE550] text-black font-bold px-4 py-2 text-sm">🏆 Certificados Fear Free</Badge>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {services.map((service) => (
              ...
              >
                {service.isPopular && (
                  <Badge className="absolute top-2.5 right-2.5 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-semibold px-3 py-1 rounded-full text-xs">
                    Más Popular
                  </Badge>
                )}
