...
interface WaveSeparatorProps {
  ...
  fromColor?: "black" | "gray" | "white" | "yellow" | "pink" | "blue"
  toColor?: "black" | "gray" | "white" | "yellow" | "pink" | "blue"
  flip?: boolean
}
...
export function WaveSeparator({
  ...
  const WavePattern = () => (
    <svg
      ...
      className={`w-full h-24 ${colorClasses[toColor]} ${flip ? "rotate-180" : ""}`}
    >
      <path
  ...
  return (
    <motion.div
      className={`relative -my-1 ${backgroundClasses[fromColor]}`}
